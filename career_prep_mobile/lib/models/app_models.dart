...
class ResumeFeedback {
  ...
  final Map<String, String> sectionTips;
  final DateTime? updatedAt;

  factory ResumeFeedback.fromJson(Map<String, dynamic> json) {
    return ResumeFeedback(
      ...
      suggestions: (json['suggestions'] as List<dynamic>? ?? <dynamic>[])
          .whereType<String>()
          .toList(),
      sectionTips: (json['sectionTips'] as Map<String, dynamic>? ?? <String, dynamic>{})
